...
namespace eRestaunrant.Web.ServiceProcessors
{
    public class ServiceProcessor : IServiceProcessor
    {
        ...
        public ServiceResponse Call<T, T2, T3,T4, TResult>(Func<T, T2, T3,T4, TResult> action, T parameter, T2 parameter2, T3 parameter3, T4 parameter4)
        {
            object result = null;
            Exception exception = null;
            try
            {
                result = action(parameter, parameter2, parameter3, parameter4);
            }
            catch (Exception e)
            {
                exception = e;
        ...
        public ServiceResponse Call<T, T2, T3,T4>(Action<T, T2, T3, T4> action, T parameter, T2 parameter2, T3 parameter3, T4 parameter4)
        {
            object result = null;
            Exception exception = null;
            ...
            try
            {
                action(parameter, parameter2, parameter3, parameter4);
            }
            catch (Exception ex)
            {
                exception = ex;
